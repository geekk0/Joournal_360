...
def start():
    try:
        ...
        start_eng_publisher = datetime.strptime('Oct 14 2021  9:10AM', '%b %d %Y %I:%M%p')
        start_eng_updater = datetime.strptime('Oct 14 2021  9:20AM', '%b %d %Y %I:%M%p')
        start_eng_email_sender = datetime.strptime('Oct 14 2021  11:01AM', '%b %d %Y %I:%M%p')
        start_eng_finalizer = datetime.strptime('Oct 14 2021  8:01PM', '%b %d %Y %I:%M%p')

        start_it_publisher = datetime.strptime('Oct 14 2021  10:30AM', '%b %d %Y %I:%M%p')
        start_it_updater = datetime.strptime('Oct 14 2021  10:43AM', '%b %d %Y %I:%M%p')
        start_it_email_sender = datetime.strptime('Oct 14 2021  10:31AM', '%b %d %Y %I:%M%p')
